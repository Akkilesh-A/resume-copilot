...
st.markdown("""
    <a href="http://localhost:5173/jobs" class="custom_button" target = "_self"> 
            <p>
                Go Back
            </p>     
    </a>
...
if uploaded_files and len(uploaded_files) > 1:
    ...
    if match_percentage >= 70:
        st.success(f" Match {match_percentage_str} - This resume matches the job description!")  # Highlight in green for a good match
    else:
