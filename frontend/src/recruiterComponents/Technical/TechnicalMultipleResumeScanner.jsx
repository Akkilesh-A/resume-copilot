...
function TechnicalMultipleResumeScanner() {
    ...
    return (
        <div className='mt-24 mx-8'>
            <div className='flex justify-center items-center mb-12'>
                <h1 className='text-[2.5em] font-extrabold'>🧑🏻‍🏫 Get the Best Technical Candidates here! 👩🏻‍🏫</h1>
            </div>
...
export default TechnicalMultipleResumeScanner;
