...
if submit_button:
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if match_percentage >= minimum_passing_score:
            ...
            for i, candidate_info in enumerate(selected_candidates, start=1):
                st.markdown(
                    ...
                    <div class="selected-candidate">
                        <p><span class="candidate-number">{i}.</span> <span class="candidate-name">{candidate_info[0]}</span> | <span class="candidate-mobile">{candidate_info[1]}</span></p>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
